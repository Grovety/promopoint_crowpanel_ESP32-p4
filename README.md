...
| Package | Description |
| --- | --- |
| [MediaPlayer-for-CrowPanel-p4-v1.2.zip](./MediaPlayer-for-CrowPanel-p4-v1.2.zip) | PromoPoint firmware and the Windows flashing tool for panel **V1.2** |
| [MediaManager-for-Windows.zip](./MediaManager-for-Windows.zip) | Media Manager — the Windows application for managing the panel's media content |
